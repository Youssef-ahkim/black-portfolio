...
export default function Services() {
  ...
  return (
    <section 
      id="services" 
      className="relative overflow-hidden pt-25" // add padding top for fixed nav
            ...
            return (
              <div 
                ...
                className={`animate-pop-in [animation-delay:${service.delay}] opacity-0
                  ...
                  hover:bg-white/10 hover:border-${color}/40
                  hover:-translate-y-2 hover:shadow-xl
                  focus:outline-none focus:ring-2 focus:ring-${color}/30
                  group`}
                role="region"
